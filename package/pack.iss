...
Source: "..\case\*"; DestDir: "{app}\case"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\res\*"; DestDir: "{app}\res"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\solver\*"; DestDir: "{app}\solver"; Flags: ignoreversion recursesubdirs createallsubdirs
