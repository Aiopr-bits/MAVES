	...
	, ui(new Ui::FormThermoListWidgetClass())
{
	...
	ui->lineEdit_39->setValidator(validator);
	ui->lineEdit_40->setValidator(validator);
	ui->lineEdit_41->setValidator(validator);
	ui->lineEdit_42->setValidator(validator);
	ui->lineEdit_43->setValidator(validator);
	ui->lineEdit_44->setValidator(validator);
	ui->lineEdit_45->setValidator(validator);
	ui->lineEdit_46->setValidator(validator);
	...
	ui->lineEdit_88->setValidator(validator);
	ui->lineEdit_89->setValidator(validator);
	ui->lineEdit_90->setValidator(validator);
	ui->lineEdit_91->setValidator(validator);
	ui->lineEdit_92->setValidator(validator);
	ui->lineEdit_93->setValidator(validator);
	ui->lineEdit_94->setValidator(validator);
	...
	ui->lineEdit_31->setValidator(validator);
	ui->lineEdit_32->setValidator(validator);
	ui->lineEdit_33->setValidator(validator);
	ui->lineEdit_34->setValidator(validator);
	ui->lineEdit_35->setValidator(validator);
	ui->lineEdit_38->setValidator(validator);
	ui->lineEdit_37->setValidator(validator);
	ui->lineEdit_36->setValidator(validator);

	ui->lineEdit_71->setValidator(validator);
	ui->lineEdit_72->setValidator(validator);
	ui->lineEdit_73->setValidator(validator);
	ui->lineEdit_74->setValidator(validator);
	ui->lineEdit_75->setValidator(validator);
	ui->lineEdit_76->setValidator(validator);
	ui->lineEdit_77->setValidator(validator);
	ui->lineEdit_78->setValidator(validator);
