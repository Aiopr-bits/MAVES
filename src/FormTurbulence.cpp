	...
	, ui(new Ui::FormTurbulenceClass())
{
	...
	ui->lineEdit_47->setValidator(validator);
	ui->lineEdit_48->setValidator(validator);
	ui->lineEdit_49->setValidator(validator);
	ui->lineEdit_50->setValidator(validator);
	ui->lineEdit_51->setValidator(validator);
	ui->lineEdit_52->setValidator(validator);
	...
	ui->lineEdit_95->setValidator(validator);
	ui->lineEdit_96->setValidator(validator);
	ui->lineEdit_97->setValidator(validator);

	ui->lineEdit_98->setValidator(validator);
	ui->lineEdit_99->setValidator(validator);
	ui->lineEdit_100->setValidator(validator);
	ui->lineEdit_101->setValidator(validator);
	ui->lineEdit_102->setValidator(validator);

	ui->lineEdit_103->setValidator(validator);
	ui->lineEdit_104->setValidator(validator);
	ui->lineEdit_105->setValidator(validator);
	ui->lineEdit_106->setValidator(validator);
	ui->lineEdit_107->setValidator(validator);
	ui->lineEdit_108->setValidator(validator);
	ui->lineEdit_109->setValidator(validator);
	ui->lineEdit_110->setValidator(validator);
	ui->lineEdit_111->setValidator(validator);
	ui->lineEdit_112->setValidator(validator);
	ui->lineEdit_113->setValidator(validator);
	ui->lineEdit_114->setValidator(validator);

	ui->lineEdit_132->setValidator(validator);
	ui->lineEdit_133->setValidator(validator);
	ui->lineEdit_134->setValidator(validator);
	ui->lineEdit_135->setValidator(validator);
	ui->lineEdit_136->setValidator(validator);
	ui->lineEdit_137->setValidator(validator);
	ui->lineEdit_138->setValidator(validator);
	ui->lineEdit_202->setValidator(validator);
	ui->lineEdit_206->setValidator(validator);
	ui->lineEdit_207->setValidator(validator);
	ui->lineEdit_208->setValidator(validator);
	ui->lineEdit_209->setValidator(validator);
	ui->lineEdit_210->setValidator(validator);
	ui->lineEdit_211->setValidator(validator);
	ui->lineEdit_212->setValidator(validator);
	ui->lineEdit_213->setValidator(validator);
	ui->lineEdit_214->setValidator(validator);

	ui->lineEdit_215->setValidator(validator);
	ui->lineEdit_216->setValidator(validator);
	ui->lineEdit_217->setValidator(validator);
	ui->lineEdit_218->setValidator(validator);
	ui->lineEdit_219->setValidator(validator);
	ui->lineEdit_220->setValidator(validator);
	ui->lineEdit_221->setValidator(validator);

	ui->lineEdit_221->setValidator(validator);
	ui->lineEdit_222->setValidator(validator);
	ui->lineEdit_223->setValidator(validator);
	ui->lineEdit_224->setValidator(validator);
	ui->lineEdit_225->setValidator(validator);	
	ui->lineEdit_226->setValidator(validator);
	ui->lineEdit_227->setValidator(validator);
	ui->lineEdit_228->setValidator(validator);
	ui->lineEdit_229->setValidator(validator);
	ui->lineEdit_230->setValidator(validator);
	ui->lineEdit_231->setValidator(validator);
	ui->lineEdit_232->setValidator(validator);
	ui->lineEdit_233->setValidator(validator);
	ui->lineEdit_234->setValidator(validator);
	ui->lineEdit_235->setValidator(validator);
	ui->lineEdit_236->setValidator(validator);
	ui->lineEdit_237->setValidator(validator);
	ui->lineEdit_238->setValidator(validator);

	ui->lineEdit_239->setValidator(validator);
	ui->lineEdit_240->setValidator(validator);
	ui->lineEdit_241->setValidator(validator);
	ui->lineEdit_242->setValidator(validator);
	ui->lineEdit_243->setValidator(validator);
	ui->lineEdit_244->setValidator(validator);
	ui->lineEdit_245->setValidator(validator);
	ui->lineEdit_246->setValidator(validator);
	ui->lineEdit_247->setValidator(validator);
	ui->lineEdit_248->setValidator(validator);
	ui->lineEdit_249->setValidator(validator);
	ui->lineEdit_250->setValidator(validator);
	ui->lineEdit_251->setValidator(validator);
	ui->lineEdit_252->setValidator(validator);
	ui->lineEdit_253->setValidator(validator);
	ui->lineEdit_254->setValidator(validator);
	ui->lineEdit_255->setValidator(validator);
	ui->lineEdit_256->setValidator(validator);
	ui->lineEdit_257->setValidator(validator);

	ui->lineEdit_258->setValidator(validator);
	ui->lineEdit_259->setValidator(validator);
	ui->lineEdit_260->setValidator(validator);
	ui->lineEdit_261->setValidator(validator);
	ui->lineEdit_262->setValidator(validator);
	ui->lineEdit_263->setValidator(validator);
	ui->lineEdit_264->setValidator(validator);
	ui->lineEdit_265->setValidator(validator);
	ui->lineEdit_266->setValidator(validator);
	ui->lineEdit_267->setValidator(validator);
	ui->lineEdit_268->setValidator(validator);
	ui->lineEdit_269->setValidator(validator);

	ui->lineEdit_270->setValidator(validator);
	ui->lineEdit_271->setValidator(validator);
	ui->lineEdit_272->setValidator(validator);
	ui->lineEdit_273->setValidator(validator);
	ui->lineEdit_274->setValidator(validator);
	ui->lineEdit_275->setValidator(validator);
	ui->lineEdit_276->setValidator(validator);
	ui->lineEdit_277->setValidator(validator);
	ui->lineEdit_315->setValidator(validator);
	ui->lineEdit_316->setValidator(validator);
	ui->lineEdit_317->setValidator(validator);
	ui->lineEdit_318->setValidator(validator);

	ui->lineEdit_319->setValidator(validator);
	ui->lineEdit_320->setValidator(validator);
	ui->lineEdit_321->setValidator(validator);
	ui->lineEdit_322->setValidator(validator);
	ui->lineEdit_323->setValidator(validator);
	ui->lineEdit_324->setValidator(validator);
	ui->lineEdit_325->setValidator(validator);
	ui->lineEdit_326->setValidator(validator);
	ui->lineEdit_327->setValidator(validator);
	ui->lineEdit_328->setValidator(validator);
	ui->lineEdit_329->setValidator(validator);
	ui->lineEdit_330->setValidator(validator);

	ui->lineEdit_331->setValidator(validator);
	ui->lineEdit_332->setValidator(validator);
	ui->lineEdit_333->setValidator(validator);
	ui->lineEdit_334->setValidator(validator);
	ui->lineEdit_335->setValidator(validator);
	ui->lineEdit_336->setValidator(validator);
	ui->lineEdit_337->setValidator(validator);
	ui->lineEdit_338->setValidator(validator);
	ui->lineEdit_339->setValidator(validator);
	ui->lineEdit_340->setValidator(validator);
	ui->lineEdit_341->setValidator(validator);
	ui->lineEdit_342->setValidator(validator);
	ui->lineEdit_343->setValidator(validator);
	ui->lineEdit_344->setValidator(validator);
	ui->lineEdit_345->setValidator(validator);

	ui->lineEdit_297->setValidator(validator);
	ui->lineEdit_298->setValidator(validator);
	ui->lineEdit_299->setValidator(validator);
	ui->lineEdit_300->setValidator(validator);
	ui->lineEdit_301->setValidator(validator);
	ui->lineEdit_302->setValidator(validator);
	ui->lineEdit_303->setValidator(validator);
	ui->lineEdit_304->setValidator(validator);
	ui->lineEdit_305->setValidator(validator);
	ui->lineEdit_306->setValidator(validator);
